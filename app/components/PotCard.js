...
const PotCard = () => {
  ...
  const {connected, isMasterInitialized, initMaster, createLottery, lotteryId, lotteryPot, buyTicket, isLotteryAuthority,isFinished, canClaim, pickWinner, lotteryHistory, claimPrize} = useAppContext();
    ...
    return (
      <div className={style.wrapper}>
        ...
        {connected ? (
          ...
          <button onClick={connectWallet}>cc</button>
        )}
      </div>
    );
